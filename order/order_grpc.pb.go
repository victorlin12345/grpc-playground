...
func (c *orderClient) CreateOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderReply, error) {
	out := new(OrderReply)
...
func (UnimplementedOrderServer) CreateOrder(context.Context, *OrderRequest) (*OrderReply, error) {
